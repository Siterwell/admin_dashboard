        ...
        <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
          <router-link to="/alerts">
            <b-card class="text-white bg-warning">
              ...
              <div class="text-uppercase font-weight-bold" style="height:45px;">Battery</div>
            </b-card>
          </router-link>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
          <router-link to="/alerts">
            <b-card class="text-white bg-warning">
              ...
              <div class="text-uppercase font-weight-bold" style="height:45px;">Offline</div>
            </b-card>
          </router-link>
        </div><!--/.col-->
        <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
          <router-link to="/alerts">
            <b-card class="text-white bg-warning">
              ...
              <div class="text-uppercase font-weight-bold" style="height:45px;">Faulty</div>
            </b-card>
          </router-link>
        </div><!--/.col-->
      </div><!-- /.row   -->
